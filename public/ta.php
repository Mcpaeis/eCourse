...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="ta/css/ta.css">
	...
	<body>
		...
		<section class="">
			<div id="commands" class="col-sm-3 panel-group">
				...
				<div class="panel panel-default">
					...
					<div class="panel-collapse collapse" id="course">
						<div class="panel_body">
							...
							<form>
								<input type="text" name="txtTitle" placeholder="Title"><br /><br />
								<textarea name="txtSubject" cols="30" rows="10">Type Assignment Content here......</textarea><br /><br />
								...
								<select name ="postMonth" onchange="hide_text();">
									<option>Month</option>
								...
								<input type="submit" value="POST" name="postAssignment" style="width: auto;"><br /><br /><br /><br />
							</form>
							<span>Schedule Test</span>
							<form>
								<input type="text" name="txtTitle" placeholder="Test Caption......"><br /><br />
								<textarea name="txtDescription" cols="30" rows="5">Type Test Description or Recommended Readings.....</textarea><br /><br />
								...
								<input type="submit" value="Schedule" name="postSchedule" style="width: auto;">
							</form>
						</div>
					</div>
				</div>
				<div id="announcements">
					...
					<textarea rows="4">Type announcement Here.....</textarea><br />
					<input type="submit" value = "Post"><br /><br />
					<span>Previous Annoucement</span><br />
					<i>No previous announcements......</i> 
				</div>
			</div>
		...
		<footer>
			...
			<script type="text/javascript" src="ta/js/ta.js"></script>
		</footer>
	</body>
</html>